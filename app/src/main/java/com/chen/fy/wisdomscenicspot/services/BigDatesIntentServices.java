...
public class BigDatesIntentServices extends IntentService {
    ...
    protected void onHandleIntent(@Nullable Intent intent) {
        ...
        try {
            ...
            if (response.body() != null) {
                ...
                Log.d("日志", "responseData:" + responseData);
    ...
    private void saveDates(String responseData) {
        ...
        editor.putString("temperature_wl", dates_wl[0]);
        editor.putString("humidity_wl", dates_wl[1]);
        editor.putString("pressure_wl", dates_wl[2]);
        editor.putString("visibility_wl", dates_wl[3]);
        editor.putString("rainfall_wl", dates_wl[4]);

        editor.putString("temperature_fj", dates_fj[0]);
        editor.putString("humidity_fj", dates_fj[1]);
        editor.putString("pressure_fj", dates_fj[2]);
        editor.putString("visibility_fj", dates_fj[3]);
        editor.putString("rainfall_fj", dates_fj[4]);
        ...
        editor.putString("temperature_sq_t", dates_sq_t[0]);
        editor.putString("humidity_sq_t", dates_sq_t[1]);
        editor.putString("pressure_sq_t", dates_sq_t[2]);
        editor.putString("visibility_sq_t", dates_sq_t[3]);
        editor.putString("rainfall_sq_t", dates_sq_t[4]);

        editor.putString("temperature_dz_t", dates_dz_t[0]);
        editor.putString("humidity_dz_t", dates_dz_t[1]);
        editor.putString("pressure_dz_t", dates_dz_t[2]);
        editor.putString("visibility_dz_t", dates_dz_t[3]);
        editor.putString("rainfall_dz_t", dates_dz_t[4]);

        editor.putString("temperature_wl_t", dates_wl_t[0]);
        editor.putString("humidity_wl_t", dates_wl_t[1]);
        editor.putString("pressure_wl_t", dates_wl_t[2]);
        editor.putString("visibility_wl_t", dates_wl_t[3]);
        editor.putString("rainfall_wl_t", dates_wl_t[4]);

        editor.putString("temperature_fj_t", dates_fj_t[0]);
        editor.putString("humidity_fj_t", dates_fj_t[1]);
        editor.putString("pressure_fj_t", dates_fj_t[2]);
        editor.putString("visibility_fj_t", dates_fj_t[3]);
        editor.putString("rainfall_fj_t", dates_fj_t[4]);
